...
export function PickSheet({
  ...
  return (
    <>
      {/* An overlay, so the page it points at is still behind it. As an early
          return it replaced the sheet, leaving nothing to come back to. */}
      {done && (
        <PicksSubmitted
          ...
          // Dismissing leaves them on the standings, which is where the modal
          // was pointing them anyway.
          onDone={() => {
            setDone(null);
            onViewStandings?.();
          }}
