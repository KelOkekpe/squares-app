...
export const colors = {
  ...
  pickWinBg: "var(--pick-win-bg)",
  pickWinBorder: "var(--pick-win-border)",
  pickLossBg: "var(--pick-loss-bg)",
  pickLossBorder: "var(--pick-loss-border)",
  pickLeadBorder: "var(--pick-lead-border)",
